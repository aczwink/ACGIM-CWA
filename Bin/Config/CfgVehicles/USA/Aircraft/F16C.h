...
class USA_F16 : A10
{
	model = "\models\Vit_Isr_F16c.p3d";
	picture = "\tex\f16_pic.paa";
	icon = "\tex\f16_icon.paa";
	soundEngine[]={"\sounds\f16_eng1.wav",db30,.85};
	dammageHalf[] = {
		"\tex\f16_window.paa","\tex\f16_window_b.paa",
		"\tex\f16_main.pac","\tex\f16_main_b.pac"
	};
	dammageFull[] = {
		"\tex\f16_window.paa","\tex\f16_window_c.paa",
		"\tex\f16_main.pac","\tex\f16_main_c.paa"
	};
	...
	class UserActions
	{
		...
		class BurnerOn
		{
			...
			radius=3;
			condition="this animationPhase ""flammen"" <=0.5 and isengineon this";
			statement="this animate [""flammen"", 1],[this] exec ""\acgim_scripts\Vehicles\F16\f16turbo_on.sqs"""
		};
	};

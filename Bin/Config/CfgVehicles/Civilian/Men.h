class Civilian : Man
{
	...
	wounds[]={
		...
		"\o\char\New_civlegsT.pac","\o\char\New_civlegsT_i.pac",
		"\o\char\New_civtopT1.pac","\o\char\New_civtopT1_i.pac",
		"\o\char\New_civtopT2.pac","\o\char\New_civtopT2_i.pac",
		"\o\char\New_civtopT3.pac","\o\char\New_civtopT3_i.pac",
		"\o\char\New_civtopT4.pac","\o\char\New_civtopT4_i.pac",
		...
		"\o\misc\nada.pac","\o\misc\nada_d.pac",
		"\o\char\Civ_leg_dgre.pac","\o\char\Civ_leg_dgre_i.pac",
		"\o\char\Civ_top_pul_r.pac","\o\char\Civ_top_pul_r_i.pac",
		"\o\char\Civ_top_pulo.pac","\o\char\Civ_top_pulo_i.pac",
		"\o\char\Civ_top_jacket.pac","\o\char\Civ_top_jacket_i.pac",
		"\o\char\Civ_top_jack_r.pac","\o\char\Civ_top_jack_r_i.pac",
		"\o\char\new_civ_jeans.pac","\o\char\new_civ_jeans_i.pac",
		"\o\char\tom_civ_top.pac","\o\char\tom_civ_top_i.pac",
		"\o\char\tom_civ_ruk.pac","\o\char\tom_civ_ruk_i.pac",
		...
		"\o\char\honza_civ_top.pac","\o\char\honza_civ_top_i.pac",
		"\o\char\honza_civ_ruk.pac","\o\char\honza_civ_ruk_i.pac",
		"\o\char\cern_civ_top.pac","\o\char\cern_civ_top_i.pac",
		"\o\char\cern_civ_ruk.pac","\o\char\cern_civ_ruk_i.pac",
		"\o\char\club_civ_T-s copy.pac","\o\char\club_civ_T-sc_i.pac"
	};
	moves="CfgMovesMC";
	accuracy=0.4;
	type=0;
...
{
	scope = SCOPE_HIDDEN; //civilians normally don't have a parachute... but they also can use aircrafts
	side = SIDE_CIVILIAN;
	crew = "Civilian";
};
#define VEH_DIE_CONN(Name,anim,time) \
		...
		VEH_MOVES_VAR(OWPMi8pilot, \sjc_anims\mi8\OWPMi8pilot, 1, 5);
        VEH_MOVES_VAR(OWPMi8copilot, \sjc_anims\mi8\OWPMi8copilot, 1, 5);
        VEH_MOVES_VAR(OWPMi8GunnerFront, \sjc_anims\mi8\OWPMi8GunnerFront, 1, 5);

class OWPMi8Pilotengineon: StandBase
{
	speed = -4;
	looped=0;
	file="\animations\OWPMi8Pilotengineon.rtm";

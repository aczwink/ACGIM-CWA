...
if(_w=="RHS_smokeDischarger")then{if(typeOf _t=="T80")then{_n=7;_lw=100;_nw=14.3;};if(typeOf _t in["RHS_T80BV","RHS_T80BM1","RHS_T80U","RHS_T80UD","RHS_T80UM"])then{_n=8;_lw=120;_nw=15;};[_t,_n,_lw,_nw,40,true,40,false]exec "\RHS_Misc\armour\smoke\MAP_fireSmoke.sqs";}else{
